...
import { PROJECT_CATEGORY_DESCRIPTIONS, PROJECT_CATEGORY_VARIANTS, PROJECT_STATUS_DESCRIPTIONS, PROJECT_STATUS_VARIANTS } from '../constants/variants';
...
export function getCategoryDescription(category?: ProjectCategory): string | undefined {
  if (!category) return undefined;
  return PROJECT_CATEGORY_DESCRIPTIONS[category];
}
