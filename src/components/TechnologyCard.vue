...
<template>
  <li
    class="border border-muted-foreground/50 rounded-md p-4 bg-white/5 backdrop-blur-[1px] hover:bg-white/10 hover:shadow-lg transition-all duration-300"
    :class="{ 'ring ring-sky-500/80': isSelected }"
  >
    <div class="mb-3">
      <div class="flex justify-between items-center mb-2">
        <h4 class="text-lg font-bold">{{ technology.name }}</h4>
      ...
      <p class="text-xs text-muted-foreground bg-white/10 mb-3">
